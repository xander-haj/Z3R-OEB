...
const WORKFLOW_SECTIONS = [
  {
    ...
    lines: [
      ...
      "- `Dump Base Overworld` appears only when `assets/overworld_dump` is missing.",
      "",
  ...
  },
  {
    ...
    lines: [
      ...
      "- Right-click the destination cell on the canvas.",
      "- Choose `Paint` or the marker-specific action from the context menu.",
